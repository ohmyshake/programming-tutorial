...
- When you login successfully, it will generate a file `.globus/cli/storage.db`, which will remember your login info, so avoids the repeated login actions next time. 
