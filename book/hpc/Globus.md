...
- When you login successfully, it will generate a file `.globus/cli/storage.db`, which will remember you login info, so avoids the repeated login actions next time. 
