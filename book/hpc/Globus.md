...
### 2. Shell Script
Sometimes you may have a lot of files (not a single file) to transfer, you need to write a script to do this work. `globus-cli` provides a command-line shell tool to transfer data, and install it firstly:
